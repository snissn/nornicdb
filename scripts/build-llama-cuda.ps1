...
#
# Usage:
#   .\scripts\build-llama-cuda.ps1 [-Version b9835] [-Clean]
#
# Output:
...
param(
    [string]$Version = "b9835",  # Latest stable llama.cpp release tag
    [switch]$Clean
)
...
if (Test-Path $rootCMakePath) {
    ...
    # Comment out add_subdirectory(app) -- new in b9835, depends on llama-server-impl
